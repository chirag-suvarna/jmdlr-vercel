...
import ActivityChart from "@/components/paper-detail/ActivityChart";
import MetricsCards from "@/components/paper-detail/MetricsCards";
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <select
              ...
              className="rounded-full border border-[color:var(--color-border)] bg-[color:var(--color-bg-secondary-70)] px-3 py-1 text-[11px] font-semibold text-[color:var(--color-text-secondary)] shadow-[var(--shadow-card)] transition focus:border-[color:var(--color-border-strong)] focus:outline-none focus:ring-2 focus:ring-[color:var(--color-bg-muted)]"
            >
